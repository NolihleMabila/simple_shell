...
/**
 *struct passinfo - contains all the argunents that will passed
 *@arg: arguements
 *@argv: arg vector
 *@path: path of the commnd
 *@argc: args count
 *@line_count: the error count.
 *@err_num: the error code for exit()s.
 *@linecount_flag:  line flag.
 *@fname: progrm filenam.
 *@env: environ.
 *@environ: copy of environ.
 *@hist: history node.
 *@alias: alias noide.
 *@env_changed: environ was changed this will be on.
 *@status: returns the status of the last executed command.
 *@cmd_buf: command buffer.
 *@cmd_buf_type: CMD_type ||, &&, ;.
 *@readfd: fd read
 *@histcount: line count
 */
